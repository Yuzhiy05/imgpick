...
### 10.11 手动匹配功能
**需求**：在图片管理页面右键已标价图片，弹出手动匹配窗口
**实现**：
- 新增 `ManualMatchWindow` 独立窗口组件
- 右键图片时创建并显示手动匹配窗口
- 窗口中可粘贴剪贴板数据（样本ID、孔位结果、考察时间）
- 支持根据孔位结果搜索匹配图片
- 确认后复制图片到final目录并更新数据库
**状态**：✅ 已完成
